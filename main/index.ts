...
while (true) {
    ...
    if (primeiroNumero) {
        ...
        if (numero > (maior as number)) maior = numero;
        if (numero < (menor as number)) menor = numero;
    }
}
...
let menorPositivoImpar: number | undefined;
...
while (true) {
    ...
    if (numSeq7 > 0 && numSeq7 % 2 !== 0) {
        if (primeiroNumPositivoImpar) {
            ...
            if (numSeq7 < (menorPositivoImpar as number)) {
                menorPositivoImpar = numSeq7;
            }
        }
    }
